...
# Please set up language: "POL" or "ENG"
language = "ENG"
```
...
<font size=4> Even though the highest Balanced Accuracy was performed by Random Forest, ultimately we decided to go with SVM method which expected Balance Accuracy is `r paste0(round(balanced_accuracy[3],4)*100,"%")`. </font>
